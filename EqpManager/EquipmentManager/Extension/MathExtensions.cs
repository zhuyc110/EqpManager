...
namespace EquipmentManager.Extension
{
    public static class MathExtensions
    {
        ...
        {
            var step = start <= bound ? (decimal) 1 : (decimal) -1;
        ...
        {
            var step = start <= bound ? (double) 1 : (double) -1;
        ...
        {
            var step = start <= bound ? (float) 1 : (float) -1;
        ...
        {
            var step = start <= bound ? (long) 1 : (long) -1;
        ...
        {
            var step = start <= bound ? (int) 1 : (int) -1;
